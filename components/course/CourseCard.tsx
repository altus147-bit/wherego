  ...
  return (
    ...
    >
      <div className="relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl bg-ink-100">
        ...
        {rank !== undefined && (
          <span className="absolute left-1.5 top-1.5 z-10 flex h-6 w-6 items-center justify-center rounded-md bg-brand-500 text-xs font-bold text-white shadow-soft">
            {rank}
          </span>
        )}
      </div>
